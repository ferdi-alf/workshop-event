        ...
        @if ($searchBar)
            <div class="relative max-w-sm mt-6">
                ...
                <input type="text" id="search-input-{{ $uniqueTableId }}"
                    class="bg-white/15 backdrop-blur-2xl shadow-md border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5"
                    placeholder="Search...">
            </div>
        @endif
